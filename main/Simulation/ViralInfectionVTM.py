...
from ViralInfectionVTMSteppables import InternalizationBlockerSteppable
CompuCellSetup.register_steppable(steppable=InternalizationBlockerSteppable(frequency=1))

from ViralInfectionVTMSteppables import ReplicationBlockerSteppable
CompuCellSetup.register_steppable(steppable=ReplicationBlockerSteppable(frequency=1))
